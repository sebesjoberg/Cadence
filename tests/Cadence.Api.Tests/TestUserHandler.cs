...
/// <summary>
/// Mints a user principal from a header instead of a real sign-in. Opt-in: a test wires this scheme
/// into a host policy of its own, the way <c>TokenScopeTests</c> does for a host-owned policy.
/// </summary>
